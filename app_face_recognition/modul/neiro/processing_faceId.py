...
class processing_faceid(threading.Thread):
    ...
    def __init__(self, queue, model_cvm, model_knn, face_detector, path_madel, door:periphery, dict_res):
        super().__init__()
    ...
    def getFace(self, frame_RGB):
        ...
        for (x, y, w, h) in faces:
            ...
            print("shape: ", frame_RGB.shape, "xywh", x, y, w, h)
    ...
    def run(self):
        ...
        while True:
            ...
            for count, (fase_RGB_200_200, (x, y, w, h)) in enumerate(face_locations):
                ...
                dict_res[str(count)] = {}
                dict_res[str(count)]['bbox'] = [x, y, w, h]
                dict_res[str(count)]['name'] = 'none'



            self.dict_res = dict_res

            cv2.imshow("wed", frame)
            cv2.waitKey(1)
